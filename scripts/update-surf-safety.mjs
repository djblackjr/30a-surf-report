...
Check the South Walton Fire District's surf conditions page (swfd.org/beach-safety/surf-conditions) for today's posted flag color. Also check the NWS Surf Zone Forecast for the Florida panhandle coast (issued by NWS Tallahassee, forecast.weather.gov) for today's rip current risk category and surf height range.
...
If you cannot find a genuinely current (today's) flag status or surf zone forecast, say so honestly in "notes" rather than guessing — do not invent a flag color you didn't actually find.
